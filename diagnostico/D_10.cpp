    ...
    void modificateArticle(int id, float precie, int stock){
        ...
        for (int i = 0; i<listarticles.size(); i++)
        {
            if (id==listarticles[i]->getid())
            {
                ...
                listarticles[i]->modificarStock(stock);
...
public:
    ...
    void createuser(const string& name, const string& password, string rol){
        ...
        shared_ptr<User> usernuevo = nullptr;
        if (rol == "Cliente")
        {
            
            usernuevo = make_shared<Client>();
        ...
        if (rol == "Administrador")
        {
            ...
            usernuevo = make_shared<Administrator>();
        ...
        if (rol == "Vendedor")
        {
            ...
            usernuevo = make_shared<Vendedor>();
        ...
        if (rol == "Trabajador_deposito")
        {
            ...
            usernuevo = make_shared<Warehouse_workers>();
...
private:
    ...
    void menuVendedor() {
        ...
        do {
            ...
            switch (opcion) {
                case 1: requestDatasArticle(); break;
    ...
    void hacerPedido() {
        ...
        do
        {
            ...
            cin >> letra;
            if (letra != "Si" && letra != "si")
            {
                cout << "Incorrecto: ingrese Si/si, para comprar " << endl;
                continue;
            }
        ...
        void showMenu() {
            ...
            do {
                ...
                switch (opcion) {
                    ...
                    default: cout << "Opcion inválida. Intente de nuevo." << endl;
                }
            } while (opcion != 0);
        }
    };
